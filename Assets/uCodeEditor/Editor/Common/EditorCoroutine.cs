...
namespace uCodeEditor 
{
    ...
    public class EditorCoroutine
    {
        ...
        public static EditorCoroutine StartCoroutine(System.Action action)
        {
            return StartCoroutine(RoutineWrapper(action));
        }

        private static IEnumerator RoutineWrapper(System.Action action)
        {
            if (action != null)
            {
                action();
